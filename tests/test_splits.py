...
class TestBurndownDailySimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer burndown.daily")
...
class TestBurndownMonthlySimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer burndown.monthly")
...
class TestBurndownWeeklySimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer burndown.weekly")
...
class TestCalendarSimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer calendar")
...
class TestGhistoryAnnualSimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer ghistory.annual")
        output = self.read_buffer()
...
class TestGhistoryMonthlySimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer ghistory.monthly")
        output = self.read_buffer()
...
class TestHistoryAnnualSimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer history.annual")
...
class TestHistoryMonthlySimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer history.monthly")
        output = '\n'.join(self.read_buffer())
...
class TestProjectsSimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer projects")
        output = '\n'.join(self.read_buffer())
...
class TestSummarySimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer summary")
        output = '\n'.join(self.read_buffer())
...
class TestStatsSimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer stats")
        output = '\n'.join(self.read_buffer())
...
class TestTagsSimple(IntegrationTest):
    ...
    def execute(self):
        ...
        assert self.command(":py3 print(vim.current.buffer)", silent=False).startswith("<buffer tags")
        output = '\n'.join(self.read_buffer())
...
class TestSplitReplacement(IntegrationTest):
    ...
    def execute(self):
        ...
        self.command(":py3 print(len(vim.buffers))", regex='2$', lines=1)
